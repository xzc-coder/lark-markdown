...
/**
 * @Author: xy-code
 * @Description: ne-h4 标签解析器
 * @Date: 2023-10-29 16:27
 **/
public class NeH4LabelParser extends TitleLabelParser {

    private static final int MD_TITLE_LEVEL = 5;

    @Override
    public boolean isParser(WebElement webElement) {
        return StrUtil.equals(LabelAttributeName.NE_H4,webElement.getTagName());
    }
