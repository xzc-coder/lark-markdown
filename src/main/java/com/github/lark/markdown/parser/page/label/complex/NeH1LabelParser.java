...
/**
 * @Author: xy-code
 * @Description: ne-h1 标签解析器
 * @Date: 2023-10-29 16:27
 **/
public class NeH1LabelParser extends TitleLabelParser {

    private static final int MD_TITLE_LEVEL = 2;

    @Override
    public boolean isParser(WebElement webElement) {
        return StrUtil.equals(LabelAttributeName.NE_H1,webElement.getTagName());
    }
